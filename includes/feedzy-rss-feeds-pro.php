...
class Feedzy_Rss_Feeds_Pro {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'feedzy_import_extra', $plugin_admin, 'import_extra', 10, 6 );
		...
		$this->loader->add_action( 'load-feedzy_page_feedzy-integration', $plugin_admin, 'view_feedzy_settings' );
		$this->loader->add_action( 'feedzy_delete_attached_media', $plugin_admin, 'delete_attached_thumbnail', 10, 2 );
		$this->loader->add_action( 'feedzy_general_setting_before', $plugin_admin, 'add_license_section' );
		$this->loader->add_action( 'wp_ajax_feedzy_ti_toggle_license', $plugin_admin, 'toggle_license' );
		$this->loader->add_action( 'admin_action_fz_export_job', $plugin_admin, 'export_job' );
		$this->loader->add_action( 'admin_action_fz_import_job', $plugin_admin, 'import_job' );
		...
		$this->loader->add_filter( 'feedzy_integration_tabs', $plugin_admin, 'integration_tabs', 11, 1 );
		...
		$this->loader->add_filter( 'feedzy_import_terms', $plugin_admin, 'auto_map_categories', 10, 3 );
