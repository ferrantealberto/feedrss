...
class Feedzy_Rss_Feeds_Pro_Ui {
	...
	public function get_form_elements_pro( $elements ) {
		$elements['section_pro']['title']                                 = __( 'Other Options', 'feedzy-rss-feeds-pro' );
		$elements['section_pro']['description']                           = __( 'Need help? Check out our documentation.', 'feedzy-rss-feeds-pro' ) . '<br/>' . '<a href="http://docs.themeisle.com/article/277-feedzy-rss-feeds-hooks" target="_blank"><small>' . __( 'Docs FEEDZY RSS Feeds', 'feedzy-rss-feeds-pro' ) . '</small></a>';
		...
		$section_date_filter = array(
			'section_date_filter' => array(
				'title'    => __( 'Filter feed item by date range.', 'feedzy-rss-feeds-pro' ),
				'elements' => array(
					'from_datetime'   => array(
						'label'       => __( 'From', 'feedzy-rss-feeds-pro' ) . ' ',
						'placeholder' => __( 'From', 'feedzy-rss-feeds-pro' ),
						'type'        => 'datetime-local',
						'value'       => '',
					),
					'to_datetime'   => array(
						'label'       => __( 'To', 'feedzy-rss-feeds-pro' ) . ' ',
						'placeholder' => __( 'To', 'feedzy-rss-feeds-pro' ),
						'type'        => 'datetime-local',
						'value'       => '',
					),
				),
